...
export default class TodoView {
  constructor() {
    ...
    this.navbarListTimeFilters = document.querySelector(
      '#navbar-list-time-filters'
    );
    ...
    this.projectConfirmButton = document.querySelector(
  ...
  initEventListeners() {
    ...
    this.restoreDefaults.addEventListener('click', () => {
  ...
  handleTimeFilterClick(target) {
    ...
    switch (navSelection) {
      ...
      case 'Today':
        filteredTodos = myTodos.filter((todo) => isToday(todo.dueDate));
      ...
      case 'Week':
        ...
        filteredTodos = myTodos.filter((todo) => {
